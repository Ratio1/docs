---
title: Becoming a CSP
sidebar_position: 1
description: Steps to become a CSP on Ratio1
---
...
- Own at least **one Ratio1 Node Deed license**
- Run a **licensed Oracle Node**
- Deploy your **CSP escrow smart contract**

All CSP applications are subject to review and approval by the Ratio1 team.
...
To request CSP status, send an application email to:

**contact@ratio1.ai**

Include:

- Your account / wallet details  
- Information about your intended CSP usage and business plan
...
When a node is configured as an **Oracle Node** for CSP operations, it participates in network coordination and validation.

Oracle nodes:

- receive **Proof of Availability (PoA)** rewards  
- **do not receive Proof of AI (PoAI) rewards** from job execution  
