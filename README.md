...
This builds the site and serves the static output from `build/` so you can
...
This installs dependencies, builds the static site, and serves it for deployment
on Ratio1 edge nodes.

## Deployment

This template is designed specifically for deployment on Ratio1; use Ratio1 edge
nodes for hosting.
